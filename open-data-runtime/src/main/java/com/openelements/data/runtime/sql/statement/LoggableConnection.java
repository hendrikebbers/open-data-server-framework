...
public class LoggableConnection implements Connection {
    ...
    public Statement createStatement() throws SQLException {
        return new LoggableStatement(innerConnection.createStatement());
    }

    @Override
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        return new LoggablePreparedStatement(innerConnection.prepareStatement(sql));
    }
    ...
    public Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
        return new LoggableStatement(innerConnection.createStatement(resultSetType, resultSetConcurrency));
    }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency)
        ...
        return new LoggablePreparedStatement(
                innerConnection.prepareStatement(sql, resultSetType, resultSetConcurrency));
    }
    ...
    public Statement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability)
        ...
        return new LoggableStatement(
                innerConnection.createStatement(resultSetType, resultSetConcurrency, resultSetHoldability));
    }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency,
        ...
        return new LoggablePreparedStatement(
                innerConnection.prepareStatement(sql, resultSetType, resultSetConcurrency, resultSetHoldability));
    }
    ...
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        return new LoggablePreparedStatement(innerConnection.prepareStatement(sql, autoGeneratedKeys));
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        return new LoggablePreparedStatement(innerConnection.prepareStatement(sql, columnIndexes));
    }

    @Override
    public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        return new LoggablePreparedStatement(prepareStatement(sql, columnNames));
    }
